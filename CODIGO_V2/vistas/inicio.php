    ...
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="breadcrumb-holder">
                        <h1 class="main-title float-left"><span style="color: red;"><?php echo $_SESSION['datos']->tipo ?></span></h1>
            ...
            <div class="row">
                <div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
                    <div class="card-box noradius noborder bg-default">
                        ...
                        <h5 class="text-white text-uppercase m-b-20">Ventas del Día</h5>
                ...
                <div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
                    <div class="card-box noradius noborder bg-warning">
                        ...
                        <h5 class="text-white text-uppercase m-b-20">Dinero del Día</h5>
            ...
            <div class="row">
                ...
                <h4><span style="color: black;">Tabla de productos con stock menor a 10 unidades</span></h4>
