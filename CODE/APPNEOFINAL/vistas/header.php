...
<head>
    ...
    <style>
        /* Estilos personalizados para la barra del menú */
        .headerbar {
            background-color: black;
        }
        
        .headerbar-left .logo span {
            color: green;
        }
        
        .navbar-custom .nav-user .avatar-rounded {
...
<body class="adminbody" style="background-color: skyblue;">
...
<div id="main">
    ...
    <div class="headerbar">
        ...
        <div class="headerbar-left">
            <a href="inicio.php" class="logo"><img alt="Logo" src="https://previews.123rf.com/images/artistock/artistock1711/artistock171100107/90106027-restaurante-de-comida-r%C3%A1pida-de-dibujos-animados-tienda-peque%C3%B1a-ilustraci%C3%B3n-de-negocios.jpg" /> <span>APPNEO</span></a>
        </div>
            ...
            <ul class="list-inline float-right mb-0">
                ...
                <li class="list-inline-item dropdown notif">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-arrow dropdown-arrow-success dropdown-lg">
                        ...
                        <!-- Cada vez que un producto tenga un stock menor a 10 unidades, aparecerá un mensaje de advertencia --->
