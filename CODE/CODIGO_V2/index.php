        ...
        <div class="row">
            <div class="col-sm-9 col-md-7 col-lg-5 mx-auto"><br><br><br><br>
                <div class="card card-signin my-5">
                    <div class="card-body">
                        <h5 class="card-title text-center"><strong>NEO FAST AND GRILL INVENTARIO</strong></h5>
                        <form class="form-signin" id="frmlogin">
                            ...
                            <div class="form-label-group">
                                ...
                                <div class="password-toggle">
                                    ...
                                    <label for="showPassword" class="password-label">Mostrar contraseña</label>
                                </div>
                            </div>

                            <span class="btn btn-lg btn-success btn-block text-uppercase" id="btningresar"
                                type="submit">Iniciar Sesión</span><br>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#showPassword').change(function () {
                ...
                var passwordToggle = $('#showPassword');
